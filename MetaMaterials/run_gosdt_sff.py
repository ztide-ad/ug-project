...
w = 1
theta = None
leaves_c, pred_c, dic_c, nleaves_c, m_c, n_c, totaltime_c, time_c, R_c, COUNT_c, C_c, accu_c, best_is_cart_c, clf_c = \
bbound(x_train, y_train, 'precision', lamb, prior_metric='curiosity', w=w, theta=theta, MAXDEPTH=float('Inf'), 
           ...
           lookahead=True, lenbound=True, R_c0 = 1, timelimit=1000, init_cart = True,
